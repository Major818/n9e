...
func eventCurGets(c *gin.Context) {
	...
	events, err := models.EventCurGets(stime, etime, nodePath, query, strings.Split(priorities, ","), strings.Split(sendtypes, ","), limit, offset(c, limit))
	errors.Dangerous(err)
...
func eventHisGets(c *gin.Context) {
	...
	events, err := models.EventGets(stime, etime, nodePath, query, eventType, strings.Split(priorities, ","), strings.Split(sendtypes, ","), limit, offset(c, limit))
	errors.Dangerous(err)
